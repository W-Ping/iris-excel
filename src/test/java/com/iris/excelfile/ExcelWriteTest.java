...
//      ExcelWriteResponse export = IRISExcelFileFactory.exportV2007WithTemplate(excelWriteParam, resourcesFileInputStream);
    ...
    public void getField() {
        ...
        map.put("financial_count_actual_value", "10");
        map.put("emp_code", "09");
        map.put("financial_count_target_value", "11");
        Map<String, Object> map2 = new HashMap<>();
        map2.put("financial_count_actual_value", "12");
        map2.put("emp_code", "01");
        map2.put("financial_count_target_value", "18");
        ...
        for (CrossReportGroupModel2 d : result) {
            ...
            System.out.println(d.getFinancialCountTargetValue());
        }
    }
}
