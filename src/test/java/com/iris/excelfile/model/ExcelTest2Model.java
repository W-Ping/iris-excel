...
public class ExcelTest2Model extends BaseRowModel {
    @ExcelWriteProperty(head = {"表头1", "表头1", "表头12"}, index = 0)
    protected String p1;

    @ExcelWriteProperty(head = {"表头1", "表头1", "表头13"}, index = 1)
    protected String p2;

    @ExcelWriteProperty(head = {"表头2", "表头2", "表头2"}, index = 2)
    private int p3;

    @ExcelWriteProperty(head = {"表头3", "表头3", "表头31"}, index = 3)
    private long p4;

    @ExcelWriteProperty(head = {"表头5", "表头5", "表头51"}, index = 4)
    private String p5;

    @ExcelWriteProperty(head = {"表头5", "表头5", "表头52"}, index = 5)
    private float p6;

    @ExcelWriteProperty(head = {"表头6", "表头61", "表头612"}, index = 6)
    private BigDecimal p7;

    @ExcelWriteProperty(head = {"表头6", "表头62", "表头621"}, index = 7)
    private Date p8;

    @ExcelWriteProperty(head = {"表头6", "表头62", "表头622"}, index = 9)
    private double p9;
